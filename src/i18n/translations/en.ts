export const en = {
  ...
  // Presentation page
  "presentation.saveToArchive": "Save to Archive",
  "presentation.save": "Save",
  "presentation.saving": "Saving…",
  "presentation.archived": "Archived",
  "presentation.saveHint": "Save this analysis to review later",

  // Save modal
  "saveModal.title": "Save Analysis",
  "saveModal.explanation": "Save this financial analysis to the archive so you can review it later. Useful for comparing months and tracking your financial progress.",
  "saveModal.summary": "Summary",
  "saveModal.period": "Period",
  "saveModal.records": "Transactions",
  "saveModal.filename": "File name",
  "saveModal.cancel": "Cancel",
  "saveModal.saveButton": "Save",
  ...
  "presentation.backToStart": "Back to start",
  ...
  "slide.prev": "Prev",
  "slide.next": "Next",
  "slide.swipeHint": "Swipe or tap to navigate",
