export const pt = {
  ...
  // Presentation page
  "presentation.saveToArchive": "Guardar no Arquivo",
  "presentation.save": "Guardar",
  "presentation.saving": "A guardar…",
  "presentation.archived": "Arquivado",
  "presentation.saveHint": "Guarda esta análise para consultares mais tarde",

  // Save modal
  "saveModal.title": "Guardar Análise",
  "saveModal.explanation": "Guarda esta análise financeira no arquivo para poderes consultá-la no futuro. Útil para comparar meses e acompanhar a evolução das tuas finanças.",
  "saveModal.summary": "Resumo",
  "saveModal.period": "Período",
  "saveModal.records": "Transações",
  "saveModal.filename": "Nome do ficheiro",
  ...
  "slide.prev": "Ant.",
  "slide.next": "Seg.",
  "slide.swipeHint": "Desliza ou toca para avançar",
